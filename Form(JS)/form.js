           ...
           renders.innerHTML += `
            <div 
                ...
                <div class="flex flex-col gap-0">
                    <h2 class="text-[1rem] font-bold text-green-900 max-[40rem]:text-[0.7rem]">${members[i].name}</h2>
                    <p class="text-gray-600 font-semibold max-[40rem]:text-[0.6rem]">${members[i].email}</p>
                </div>
